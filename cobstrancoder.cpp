...
COBSTrancoder::COBSTrancoder()
{

}

void COBSTrancoder::omdEncode(const QByteArray &rawData, QByteArray &encodedData)
{
    ...
    encodedData.push_back((char)0x00);
...
COBSTrancoder::DecodeStatus COBSTrancoder::omdDecode(const QByteArray &encodedData, QByteArray &decodedData)
{
    decodedData.clear();

    qsizetype encodedDataPos = 0;
    ...
    while (encodedDataPos < encodedData.size()) {
        ...
        {
            decodedData.push_back((char)0x00);
        }
    }
}
