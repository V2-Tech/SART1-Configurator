#ifndef COBSTRANCODER_H
#define COBSTRANCODER_H
...
public:
    ...
    static void omdEncode(const QByteArray &rawData, QByteArray &encodedData);
    ...
    static DecodeStatus omdDecode(const QByteArray &encodedData, QByteArray &decodedData);
};

#endif // COBSTRANCODER_H
